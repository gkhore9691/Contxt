    ...
    <div className="flex min-h-screen items-center justify-center bg-[var(--bg-base)] px-4">
      <div className="w-full max-w-sm">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          {error && (
            <div className="rounded-lg border border-red-500/20 bg-red-500/5 px-4 py-2.5 font-sans text-[13px] text-red-400">
              {error}
            </div>
          )}
          ...
          <div>
            ...
            <input
              ...
              className="w-full rounded-lg border border-[var(--bg-border)] bg-[var(--bg-surface)] px-3.5 py-2.5 font-sans text-sm text-[var(--text-primary)] placeholder:text-[var(--text-muted)] focus:border-[var(--cx-accent)]/50 focus:outline-none focus:ring-1 focus:ring-[var(--cx-accent)]/20 transition-all"
        ...
        <p className="mt-6 text-center font-sans text-[13px] text-[var(--text-secondary)]">
          ...
          <Link href="/register" className="text-[var(--cx-accent)] hover:underline">Create one</Link>
        </p>
      </div>
    </div>
  )
